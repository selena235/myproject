...
<div id="cook1">
<button onclick="document.getElementById('localt').style.display='block'" style="width:auto;"><a href="realestate1.php" class="logo"><h4 >Welcome <?php echo $_SESSION['username']; ?></h4></a>  
</button>
...
<div class="business"> <button onclick="document.getElementById('localt').style.display='block'" style="width:auto;"><a href="forrent.php" class="logo">FOR RENT</a> 
<button onclick="document.getElementById('localt').style.display='block'" style="width:auto;"><a href="forsell.php" class="logo">FOR SELL</a> </div>
 </div>
...
<div class="wrapper"> 
<div class="card"> 
<img src="imges/photo_2022-07-24_15-19-26.jpg" alt=""> 
<div class="info">
<h5>$25,000/mo</h3> <a href="#" class="fas fa-heart"></a>
<a href="#" class="fas fa-envelope"></a> <a href="agent.php" class="fas fa-phone"></a> 
...
<a href="#" class="btn">RENT NOW</a> </div> </div>



<div class="card"> 
<img src="imges/photo_2022-07-24_15-19-32.jpg" alt=""> 
<div class="info">
<h5>$35,000/mo</h3> <a href="#" class="fas fa-heart"></a>
<a href="#" class="fas fa-envelope"></a> <a href="agent.php" class="fas fa-phone"></a> 
<h5>studio</h5> <p>bolebulbula, addisabeba, ethiopia- 400/104</p>
<h5><i class="fas fa-expand"></i> 3500 sqft </h5>
<h5> <i class="fas fa-bed"></i> 1 beds </h5>
<h5> <i class="fas fa-bath"></i> 1 baths </h5> 
<a href="#" class="btn">RENT NOW</a> </div> </div> <button><a href="forrent.php" class="btn">explore</a></button> </div></div></div></div>
...
<h5> <i class="fas fa-bath"></i> 2 baths </h5> 
<a href="#" class="btn">BUY NOW</a> </div> </div> 
<button><a href="forsell.php" class="btn">explore</a></button> </div></div>
...
<a href="realestate1.php">my account</a> 
